...
- 👉 [Complete documentation](https://docs.appseed.us/products/django-apps/soft-ui-design) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/django-apps/soft-ui-design#environment)
  - ✅ [Start the app in Docker](https://docs.appseed.us/products/django-apps/soft-ui-design#start-the-app-in-docker)
  - ✅ [Manual Build](https://docs.appseed.us/products/django-apps/soft-ui-design#manual-build)
  - ✅ [Manage App Users](https://docs.appseed.us/products/django-apps/soft-ui-design#manage-app-users)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/django-apps/soft-ui-design#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/django-apps/soft-ui-design#set-up-the-mysql-database)
  - ✅ [Adding a new app](https://docs.appseed.us/products/django-apps/soft-ui-design#adding-a-new-app)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/django-apps/soft-ui-design#static-assets-for-production)  
